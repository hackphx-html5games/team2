...
Player.prototype.update = function(position) {
  ...
  this.socket.broadcast.emit('update', this.socket.id, position);
};
...
Player.prototype.spawn = function() {
  ...
  this.socket.broadcast.emit('spawn', this.socket.id, position);
};
...
Player.prototype.disconnect = function() {
  this.socket.broadcast.emit('disconnect', this.socket.id);
...
Player.prototype.shoot = function(angle) {
  this.socket.broadcast.emit('shoot', this.socket.id, this.position.x,
...
Player.prototype.kill = function(id) {
  ...
  if (enemy) {
    this.destroyed = true;
    this.socket.broadcast.emit('kill', enemy.socket.id);
